...
export const aboutDefaults: AboutPageData = {
  ...
  coreValues: [
    { title: 'Clients First', description: 'Invest in long-term relationships with our clients through independent and trusted advice.', icon: { name: 'Users' } },
    { title: 'Integrity', description: 'Adhere to the principle of doing the ethical thing at all times and in all circumstances.', icon: { name: 'Shield' } },
    { title: 'Excellence', description: 'Strive to achieve the highest standards of quality across all investment products and reports.', icon: { name: 'Star' } },
    { title: 'Respect', description: 'Treat all people with the utmost dignity, respect, and professional appreciation.', icon: { name: 'Heart' } },
    { title: 'Partnership & Collaboration', description: 'Promote a culture of openness, shared metrics, teamwork, and client accountability.', icon: { name: 'CheckCircle' } },
    { title: 'Investment in People', description: 'Attract the most talented people and inspire them to reach their highest potential.', icon: { name: 'Lightbulb' } },
  ],
  teamVisible: true,
