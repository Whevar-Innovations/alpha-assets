...
export const aboutDefaults: AboutPageData = {
  ...
  coreValues: [
    { title: 'Clients First', description: 'Invest in long-term relationships with our clients through independent and trusted advice.', iconName: 'Users' },
    { title: 'Integrity', description: 'Adhere to the principle of doing the ethical thing at all times and in all circumstances.', iconName: 'Shield' },
    { title: 'Excellence', description: 'Strive to achieve the highest standards of quality across all investment products and reports.', iconName: 'Star' },
    { title: 'Respect', description: 'Treat all people with the utmost dignity, respect, and professional appreciation.', iconName: 'Heart' },
    { title: 'Partnership & Collaboration', description: 'Promote a culture of openness, shared metrics, teamwork, and client accountability.', iconName: 'CheckCircle' },
    { title: 'Investment in People', description: 'Attract the most talented people and inspire them to reach their highest potential.', iconName: 'Lightbulb' },
  ],
  teamVisible: true,
