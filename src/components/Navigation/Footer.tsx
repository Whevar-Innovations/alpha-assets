      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-teal-950">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold tracking-wider text-brand-gray">Subscribe to our newsletter</h3>
            ...
            <div className="flex space-x-4 pt-2">
              <a 
                ...
                className="p-2 bg-teal-950 rounded-full hover:bg-brand-primary transition-colors duration-150 text-brand-gray hover:text-white"
                aria-label="Facebook"
              >
          ...
          {/* Resources Links */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold tracking-wider uppercase text-brand-gray">Resources</h3>
          ...
          {/* Company Links */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold tracking-wider uppercase text-brand-gray">Company</h3>
            <ul className="space-y-2 text-sm text-brand-gray">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 text-xs text-brand-gray text-center md:text-left gap-4">
