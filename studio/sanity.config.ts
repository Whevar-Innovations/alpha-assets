      ...
      structure: (S) =>
        S.list()
          ...
          .items([
            ...
            S.listItem().title('🎯 Careers Page').child(S.document().schemaType('careersPage').documentId('careersPage')),
            S.divider(),
            ...
            S.listItem().title('🎯 Job Vacancies').child(S.documentTypeList('jobVacancy').title('Job Vacancies')),
